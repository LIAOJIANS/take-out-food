...
export const reqSendCode = phone => ajax(Ba + '/sendcode', {phone})
/**
 * 手机号验证码登录
 */
// export const reqSmsLogin = (phone, code) => ajax(BASE_URL + '/login_sms', {phone, code}, 'POST')
export const reqSmsLogin = (phone, code) => ajax(Ba + '/login_sms', {phone, code}, 'POST')
/**
 * 获取用户信息(根据会话)
 */
export const reqUserInfo = () => ajax(Ba + '/userinfo')
/**
 * 请求登出
 */
export const reqLogout = () => ajax(Ba + '/logout')
